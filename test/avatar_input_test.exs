defmodule AvatarInputTest do
  use ExUnit.Case

  test ":background (RRGGBBAA)" do
    assigns = %{
      background: "96C2EDCC"
    }

    assert Avatador.avatar(assigns) == ~s(<svg width="500.0px" height="500.0px" viewBox="0 0 500.0 500.0" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0"><rect x="0" y="0" width="500.0" height="500.0" rx="0.0" style="fill:rgba\(150,194,237,0.8\)" /><text x="50%" y="50%" dy=".1em" fill="rgba\(255,255,255,1\)" text-anchor="middle" dominant-baseline="middle" style="font-size:250.0px;line-height:1;color:rgba\(255,255,255,1\);font-family:Montserrat,sans-serif;"></text></svg>)
  end

  test ":background (RGB)" do
    assigns = %{
      background: "96C"
    }

    assert Avatador.avatar(assigns) == ~s(<svg width="500.0px" height="500.0px" viewBox="0 0 500.0 500.0" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0"><rect x="0" y="0" width="500.0" height="500.0" rx="0.0" style="fill:rgba\(153,102,204,1\)" /><text x="50%" y="50%" dy=".1em" fill="rgba\(255,255,255,1\)" text-anchor="middle" dominant-baseline="middle" style="font-size:250.0px;line-height:1;color:rgba\(255,255,255,1\);font-family:Montserrat,sans-serif;"></text></svg>)
  end

  test ":background (RGBA)" do
    assigns = %{
      background: "96C2"
    }

    assert Avatador.avatar(assigns) == ~s(<svg width="500.0px" height="500.0px" viewBox="0 0 500.0 500.0" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0"><rect x="0" y="0" width="500.0" height="500.0" rx="0.0" style="fill:rgba\(153,102,204,0.13\)" /><text x="50%" y="50%" dy=".1em" fill="rgba\(255,255,255,1\)" text-anchor="middle" dominant-baseline="middle" style="font-size:250.0px;line-height:1;color:rgba\(255,255,255,1\);font-family:Montserrat,sans-serif;"></text></svg>)
  end
  ...
  test ":name as Integer" do
    ...
    assert Avatador.avatar(assigns) == ~s(<svg width="500.0px" height="500.0px" viewBox="0 0 500.0 500.0" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0"><rect x="0" y="0" width="500.0" height="500.0" rx="0.0" style="fill:rgba\(150,194,237,1\)" /><text x="50%" y="50%" dy=".1em" fill="rgba\(255,255,255,1\)" text-anchor="middle" dominant-baseline="middle" style="font-size:250.0px;line-height:1;color:rgba\(255,255,255,1\);font-family:Montserrat,sans-serif;">10</text></svg>)
  end
  ...
  test ":caps value as Integer" do
    ...
    assert Avatador.avatar(assigns) == ~s(<svg width="500.0px" height="500.0px" viewBox="0 0 500.0 500.0" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0"><rect x="0" y="0" width="500.0" height="500.0" rx="0.0" style="fill:rgba\(150,194,237,1\)" /><text x="50%" y="50%" dy=".1em" fill="rgba\(255,255,255,1\)" text-anchor="middle" dominant-baseline="middle" style="font-size:250.0px;line-height:1;color:rgba\(255,255,255,1\);font-family:Montserrat,sans-serif;">JC</text></svg>)
  end
  ...
  test ":bold as Integer" do
    ...
    assert Avatador.avatar(assigns) == ~s(<svg width="500.0px" height="500.0px" viewBox="0 0 500.0 500.0" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0"><rect x="0" y="0" width="500.0" height="500.0" rx="0.0" style="fill:rgba\(150,194,237,1\)" /><text x="50%" y="50%" dy=".1em" fill="rgba\(255,255,255,1\)" text-anchor="middle" dominant-baseline="middle" style="font-size:250.0px;line-height:1;color:rgba\(255,255,255,1\);font-weight:700;font-family:Montserrat,sans-serif;">JC</text></svg>)
  end
